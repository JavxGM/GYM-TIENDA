...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed bottom-0 right-0 top-0 z-50 flex w-full max-w-md flex-col border-l border-[#2a2a2a] bg-[#111111] shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#2a2a2a] px-5 py-4">
          ...
          <button
            onClick={() => { setAbierto(false); setPaso("carrito"); }}
            className="rounded-lg p-1.5 text-gray-400 transition hover:bg-[#222] hover:text-white"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
                ...
                <div className="space-y-4">
                  {items.map((item) => (
                    <div
                      ...
                      className="flex gap-3 rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] p-3"
                    >
                      <div className="flex flex-1 flex-col gap-1">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          <button
                            ...
                            className="rounded-md bg-[#222] p-1 text-gray-400 hover:text-white"
                          >
                          ...
                          <button
                            ...
                            className="rounded-md bg-[#222] p-1 text-gray-400 hover:text-white disabled:opacity-40"
                          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-[#2a2a2a] bg-[#1a1a1a] px-3 py-2 text-sm text-white placeholder-gray-600 outline-none focus:border-orange-500"
                />
              </div>
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-400">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full resize-none rounded-lg border border-[#2a2a2a] bg-[#1a1a1a] px-3 py-2 text-sm text-white placeholder-gray-600 outline-none focus:border-orange-500"
                />
              </div>
            ...
            {paso === "carrito" ? (
              <>
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-orange-500 py-3 font-semibold text-white transition hover:bg-orange-600 active:scale-95"
                >
                  Continuar pedido
                </button>
              </>
