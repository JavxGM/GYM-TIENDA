...
const CATEGORIAS: { valor: Categoria; etiqueta: string }[] = [
  { valor: "proteina", etiqueta: "Proteínas" },
  { valor: "creatina", etiqueta: "Creatina" },
  { valor: "pre-entreno", etiqueta: "Pre-Entreno" },
  { valor: "vitaminas", etiqueta: "Vitaminas" },
  { valor: "aminoacidos", etiqueta: "Aminoácidos" },
...
export default function ProductosAdmin({
  ...
  return (
    <div>
      ...
      {/* Tabla */}
      {productos.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a] py-24 text-center">
        ...
        <div className="overflow-hidden rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a]">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#2a2a2a] text-left text-xs font-medium uppercase tracking-wide text-gray-500">
              ...
              <tbody className="divide-y divide-[#2a2a2a]">
                {productos.map((p) => (
                  <tr key={p.id} className="transition hover:bg-[#222]">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="rounded-lg p-1.5 text-gray-500 transition hover:bg-[#333] hover:text-white"
                        >
      ...
      {modalAbierto && (
        <>
          <div
            ...
            onClick={cerrar}
          />
          <div className="fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a] p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-[#2a2a2a] bg-[#111] px-3 py-2 text-sm text-white outline-none focus:border-orange-500"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full resize-none rounded-lg border border-[#2a2a2a] bg-[#111] px-3 py-2 text-sm text-white outline-none focus:border-orange-500"
                  placeholder="Sabores disponibles, tamaños, marca..."
                />
              </div>
            ...
            <div className="mt-6 flex gap-3">
              <button
                onClick={cerrar}
                className="flex-1 rounded-xl border border-[#2a2a2a] py-2.5 text-sm font-medium text-gray-400 transition hover:bg-[#222]"
              >
                Cancelar
              </button>
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-orange-500 py-2.5 text-sm font-semibold text-white transition hover:bg-orange-600 disabled:opacity-50"
              >
