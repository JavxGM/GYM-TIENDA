              ...
              {expandido === pedido.id && (
                <div className="border-t border-[#2a2a2a] px-4 py-4">
                  ...
                  <div className="mb-4 space-y-2">
                    ...
                    <div className="flex justify-between border-t border-[#2a2a2a] pt-2 text-sm font-bold">
                    ...
                    {ESTADOS.filter((e) => e.valor !== pedido.estado).map(
                      (e) => (
                        <button
                          ...
                          className="rounded-lg border border-[#2a2a2a] px-3 py-1.5 text-xs font-medium text-gray-400 transition hover:bg-[#2a2a2a] hover:text-white"
                        >
                          Marcar {e.etiqueta}
                        </button>
                      )
